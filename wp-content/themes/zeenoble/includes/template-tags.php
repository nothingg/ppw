...
if ( ! function_exists( 'themezee_display_frontpage_slideshow' ) ):
	...
	function themezee_display_frontpage_slideshow() { 
		...
		// Get Frontpage Slide #3
		$slide_three_image = esc_attr($options['themeZee_slider_three_image']);
		$slide_three_title = esc_attr($options['themeZee_slider_three_title']);
		$slide_three_content = wp_kses_post($options['themeZee_slider_three_content']);
		$slide_three_link_name = esc_attr($options['themeZee_slider_three_link_name']);
		$slide_three_link_url = esc_url($options['themeZee_slider_three_link_url']);
			...
			<div id="frontpage-slider-wrap" class="clearfix">
				<div id="frontpage-slider" class="zeeflexslider">
					<ul class="zeeslides">
						...
						<li id="slide-3" class="zeeslide">
						
							<div class="slide-entry">
						
							<?php if ( $slide_three_image <> '' ) : ?>
								<div class="slide-image">
									<?php if ( $slide_three_link_url <> '' ) : ?>
										<a href="<?php echo $slide_three_link_url; ?>" title="<?php echo $slide_three_link_name; ?>" >
									<?php endif; ?>

											<img src="<?php echo $slide_three_image; ?>" alt="slide-image" />
							...
							<?php endif; ?>
								...
								<h2 class="slide-title"><?php echo $slide_three_title; ?></h2>
								
								<?php echo $slide_three_content; ?>
							
							<?php if ( $slide_three_link_url <> '' ) : ?>
								<div class="slide-more">
									<a class="slide-link" href="<?php echo $slide_three_link_url; ?>" title="<?php echo $slide_three_link_name; ?>" >
										<?php if ( $slide_three_link_name <> '' ) : 
											echo $slide_three_link_name;
										else : 
											_e('Read more', 'zeeNoble_language');
										endif;
										?>
